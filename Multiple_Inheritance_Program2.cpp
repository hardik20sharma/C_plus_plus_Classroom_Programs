...
int main()
{
    ...
    final objFinal;
 /*read values of a,b and c - which are the private members of class A,B and C respectively using public member functions get_a(), get_b() and get_c(), by calling with the object of  final class.*/
